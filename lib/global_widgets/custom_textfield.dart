                  ...
                  return Container(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintStyle: AppTextStyles.primaryBigRegular.copyWith(
                        ...
                        focusedBorder: const OutlineInputBorder(
                          ...
                          borderSide: BorderSide(width: 1.3, color: kSSIorange),
                        ),
                        ...
                        focusedErrorBorder: const OutlineInputBorder(
                          borderRadius: BorderRadius.all(Radius.circular(34)),
                          borderSide: BorderSide(color: kSSIorange, width: 1),
                        ),
                        errorBorder: const OutlineInputBorder(
                          borderRadius: BorderRadius.all(Radius.circular(34)),
                          borderSide: BorderSide(color: pinkClr, width: 1.0),
                        ),
