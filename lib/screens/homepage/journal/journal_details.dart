...
class _JournalDetailPageState extends State<JournalDetailPage> {
  ...
  Future refreshNote() async {
    ...
    journalEntry = await SSIDatabase.instance.readJournalEntry(
      widget.journalID,
    );
    ...
    : Padding(
        ...
        child: ListView(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            QuillEditor.basic(
              controller: _controller,  // Pass the QuillController here
              config: QuillEditorConfig(), // Default config
              focusNode: FocusNode(), // Optional: FocusNode
