            ...
            children: <Widget>[
              Transform.scale(
                  ...
                  child: Stack(
                    children: [
                      ...
                      //mouth and eye color for unselected faces
                      ValueListenableBuilder<ThemeMode>(
                        valueListenable: themeManager.themeMode,
                        builder: (context,theme, snapshot) {
                          return Face(
                            circleDiameter: circleDiameter,
                            //mouth and eye color for faces
                            color:  theme == ThemeMode.dark ? Colors.grey.shade700 : const Color.fromARGB(83, 0, 0, 0),
              ...
              Padding(
                ...
                child: Opacity(
                  ...
                  child: Text(
                    text,
                    style: optionStyle ?? const TextStyle(color: Colors.white),
                  ),
                ),
              )
            ],
